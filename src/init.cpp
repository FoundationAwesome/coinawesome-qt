...
std::string HelpMessage()
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 51225 or testnet: 51223)") + "\n";
...
// TODOj check 
// Add something to coinbase scripts to satisfy the minimum size requirement
const char* pszAwesome = "Like different";
COINBASE_FLAGS << std::vector<unsigned char>(pszAwesome, pszAwesome+strlen(pszAwesome));
